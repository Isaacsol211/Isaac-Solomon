...
export const site = {
	...
	availability: 'open to part-time freelance',
	heroIntro:
...
export const servicesIntro = {
	plain: 'what I take on,',
	accent: 'and where it shipped.'
};
...
export type Service = {
	...
	summary: string;
	items: string[];
	/** A public artefact that shows the work. Omit rather than point at something private. */
...
export const about = {
	lead: 'The part after launch is the part I am good at:',
	leadAccent:
		'a rebrand with zero content migration, a storefront built for three to four launches a day, one product carried from day one to handoff.',
	paragraphs: [
		"I'm a frontend developer at Able.do, where I have built commerce storefronts, content systems and multilingual products since 2017 — including Mivi's storefront and a national talent platform with an aptitude assessment in eleven languages.",
		'What a team is left with matters more to me than the launch: content models that survive a rebrand, component systems a non-technical team runs without me, and scroll-driven work that is budgeted and measured like any other asset rather than bolted on at the end.',
...
export type Project = {
	...
	caseStudy?: string;
	/** Desktop screenshot — the featured spread, the list-row hover preview */
	desktopImage: string;
	/**
	...
	credits?: string;
	/**
	 * 'stage' is the hero's second act (first featured project only): one broad
	 * image across the paper/coal seam. 'pair' is every other featured project:
	 * frames first, at their own ratios, then the text.
	 */
	featuredLayout?: 'stage' | 'pair';
	/**
	...
	gallery?: {
		...
		alt: string;
		caption: string;
		/** CSS aspect-ratio for the frame when the image's own ratio is wrong for the layout, e.g. '5 / 6'. */
		ratio?: string;
		/** CSS object-position inside that frame. Defaults to top centre. */
		position?: string;
	}[];
...
export const projects: Project[] = [
	{
		...
		role: 'Frontend developer — the public site: pathway pages, the registration hand-off, WhatsApp onboarding and the enquiry form, on SvelteKit and Cloudflare.',
		decision: 'Onboarding runs through WhatsApp as well as the website, meeting students in a channel they already use.',
		outcome: 'Four student pathways, and an aptitude assessment in 11 languages.',
	...
	},
	{
		...
		gallery: [
			...
			},
			{
				...
				ratio: '5 / 6',
				position: '50% 50%',
				alt: 'SAUT on a laptop and a tablet: the skills dashboard and the worksheet content editor, in Arabic',
				caption: 'dashboard and content editor'
			}
		],
		featured: true
	},
	{
		...
		description:
			'Website and CMS for Godrej Foundation, the philanthropic trust of the Godrej Group, founded in 1897 — built in SvelteKit and Tailwind.',
		...
		role: 'Frontend developer — the whole frontend from their designs, wired to Able.do\'s Apex CMS and modelled for their editors.',
		...
		credits: 'v1 design system by 3 Sided Coin.',
		featuredLayout: 'pair',
		gallery: [
			{
		...
		gallery: [
			{
				...
				small: '/projects/mivi-desktop-800.webp',
				width: 1600,
				height: 667,
				alt: 'Mivi storefront hero — Immerse in Studio Quality Sound',
				caption: 'storefront — mivi.in'
			}
		],
		featured: true
	},
	...
	},
	{
		...
		category: 'Smart Home',
		description:
			'Scroll-driven animation site for India\'s fastest-growing premium smart home company. Built with SvelteKit and GSAP — pivoted from image-sequence scrubbing to a video pause-and-play approach after the initial POC turned each video into hundreds of frames — 1,440 for the longest one-minute clip.',
		tags: ['SvelteKit', 'GSAP', 'Scroll Animation', 'Performance'],
...
export type Article = {
	...
	year: string;
	/**
	 * The at-a-glance block under a case study's dek. Essays have none. Values
	 * come from the article and the project card — never widened.
	 */
	summary?: {
		role: string;
		team?: string;
...
export const writing: Article[] = [
	{
		...
		summary: {
			role: 'Day one to handoff across four years — frontend on V1, then product manager and the person extending the design system on V2.',
			team: 'Design by Tropics (Zubin). Built with Surajith on the functional side.',
			employer: 'Able.do',
			stack: 'Vue.js → SvelteKit · Rails · PostgreSQL',
			timeline: '2019 – 2023',
			outcome: 'A 65-feature roadmap shipped across six releases, through a full framework rewrite.',
			live: { label: 'saut-website-demo.able.do', href: 'https://saut-website-demo.able.do' }
		}
	},
	{
		title: 'Wearing Three Hats — Frontend Dev, PM, Designer',
		description:
			'How four years on one product turned a frontend developer into a product manager and stand-in designer, when the design studio couldn\'t keep pace — and why each role made the others better.',
	...
	},
	{
		...
		description:
			"Mivi, India's first audio manufacturing brand: 3–4 product launches a day, a platform migration mid-flight — and the design system that emerged from the pressure.",
		href: '/writing/mivi',
		tag: 'Case Study · Mivi',
		...
		summary: {
			role: 'Frontend developer from the first build to the platform migration — storefront UI, live cart and transactional mailers.',
			employer: 'Able.do',
			stack: 'Custom CMS · Apex platform (at the time)',
			timeline: '2018 – 2022',
			outcome: '100,000+ customers and 10,000+ orders managed natively after the migration.',
			live: { label: 'mivi.in', href: 'https://www.mivi.in' }
		}
	},
	{
		...
		year: '2022–24',
		summary: {
			role: 'Frontend developer on the build — SvelteKit and GSAP.',
			employer: 'Able.do',
			stack: 'SvelteKit · GSAP · Lenis',
			timeline: '2022 – 2024',
			outcome: 'Pivoted from image-sequence scrubbing to video pause-and-play after the proof of concept turned each video into hundreds of frames — 1,440 for the longest.',
			live: { label: 'keus.in', href: 'https://www.keus.in' }
		}
	},
	{
	...
	},
	{
		...
		tag: 'Case Study · Nova Rock Tools',
		subject: 'Product definition',
		readingTime: '8 min',
		year: '2026',
		summary: {
			role: 'Developer — a bilingual static site from a four-word brief, with no designer, mockups or brand guide.',
			stack: 'SvelteKit · i18n · Cloudflare Pages',
			employer: 'Freelance',
			timeline: 'June 2026',
			outcome: 'A static, bilingual, WhatsApp-first product site with a pre-filled enquiry per product.',
			live: { label: 'novarocktools.com', href: 'https://www.novarocktools.com' }
		}
	},
	{
		...
		summary: {
			role: 'Frontend developer — the public site: pathway pages, the registration hand-off, WhatsApp onboarding and the enquiry form, on SvelteKit and Cloudflare.',
			team: 'Design by 3 Sided Coin.',
			stack: 'SvelteKit · Tailwind · Cloudflare',
			timeline: '2026',
			outcome: 'Four student pathways, and an aptitude assessment in 11 languages.',
			live: { label: 'tomorrow-makers.in', href: 'https://www.tomorrow-makers.in' }
		}
	},
	{
		title: 'Building (and Rebuilding) for Godrej Foundation',
		description:
			"A website and CMS for Godrej Foundation, the philanthropic trust of the Godrej Group, founded in 1897 — built once, then rebuilt on the same CMS when Godrej Industries changed its identity in April 2026.",
		href: '/writing/godrej',
		...
		summary: {
			role: 'Frontend developer — the whole frontend from their designs, wired to Able.do\'s Apex CMS and modelled for their editors.',
			team: 'v1 design system by 3 Sided Coin.',
			stack: 'SvelteKit · Tailwind · Apex CMS',
			employer: 'Able.do',
			timeline: '2025 – 2026',
			outcome: 'A full corporate rebrand, with zero content migration.',
			live: { label: 'godrejfoundation.com', href: 'https://www.godrejfoundation.com' }
		}
	}
];
...
/** Shown under the experience list; freelance runs alongside the Able.do role, not instead of it. */
export const experienceNote = 'Since 2026 I also take freelance work part-time, alongside Able.do.';
...
/** Three frames from the archive on the homepage, by `place`. */
export const photographyTeaser = {
	places: ['Into the Fog', 'Base Camp', 'Qutub Minar'],
	linkLabel: 'All photographs'
};

export const socials = [
	{ label: 'LinkedIn', href: 'https://www.linkedin.com/in/isaacsolomondev/' },
...
export const connect = {
	eyebrow: 'A project, or a role?',
	blurb: 'One address for both. Say which it is, and what you already know about the scope, the team or the timing.',
	/**
	 * One address, two routes. Each opens a mail draft with a subject and a
	 * skeleton body, so the first message already carries what is needed.
	 */
	routes: [
		{
			label: 'about a project',
			body: 'Send the scope, the team and the timing — that is usually enough to start.',
			linkLabel: 'Email about a project',
			subject: 'Project enquiry — [your company or product]',
			mailBody: 'Hi Isaac,\n\nWhat we are building:\nScope:\nTeam:\nTiming:\n\n'
		},
		{
			label: 'about a role',
			body: 'Send the team and the stack. What I did on each build is on every project above.',
			linkLabel: 'Email about a role',
